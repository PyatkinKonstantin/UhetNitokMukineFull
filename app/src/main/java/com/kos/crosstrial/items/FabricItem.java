...
public class FabricItem extends com.kos.crossstich.items.FabricItem implements Serializable {
    private static final long serialVersionUID = -3126551896749192351L;
    int id;
    String firmFabric;
    String nameFabric;
